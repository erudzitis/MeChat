...
const ChatListBox = ({ image, username, onClick, chatPreview, borderBottom, isActive, badge }) => {
    return (
        <>
            <div className={`w-full flex flex-row flex-shrink-0 p-4 h-auto ${isActive ? "surface-card" : ""} cursor-pointer transition-all transition-duration-500 hover:surface-card border-round`} onClick={onClick}>
                ...
                <div className="flex align-items-center justify-content-center h-full w-5rem">
                    ...
                    >
                        {badge && <Badge value="NEW" severity="info" />}
                    </Avatar>
                </div>
